...
void
signal_ask_captcha_cb(PurpleSignalConnection *sa, const char *captcha){
    sa->ps.register_account(false, captcha); // TODO: give option for voice registration
}
...
signal_ask_pin(PurpleSignalConnection *sa) {
    purple_request_input(
        sa->connection, 
        "Captcha code needed", // title
        "Please enter a valid captcha code", // primary line
        "https://gitlab.com/signald/signald/-/wikis/Captchas", // secondary line
        nullptr, // default value
        false, // multiline
        true, //masked 
        nullptr, //hint
        "OK", G_CALLBACK(signal_ask_captcha_cb),
